const informationObj = {
  ...
  // 消息模块
  module: [
    { value: 'quanbu', text: '全部'},
    { value: 'gaojing', text: '告警类' },
    { value: 'chanpin', text: '产品类' },
    { value: 'caiwu', text: '财务类' },
    { value: 'huodong', text: '活动类' },
    { value: 'xitong', text: '系统类' },
    { value: 'qita', text: '其他类' },
  ],
