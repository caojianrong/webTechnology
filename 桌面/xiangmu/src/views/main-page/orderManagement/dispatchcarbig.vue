      ...
      <el-form :model="productInfo" :rules="rules" ref="productInfo" class="demo-dynamic">
        ...
        <div v-if="isBigZong" class="projectBox">
          ...
          <ul class="flex">
            ...
            <li class="noborder">
              <el-form-item prop="priceDeficitWay">
                {{this.productInfo.priceDeficitWay==1?'亏吨允许比例':'亏吨允许范围'}}
              </el-form-item>
              <!-- 亏吨计量方式 -->
              <!--<el-select-->
            ...
            <li class="noborder">
              <el-form-item prop="priceDeficitWay">
                {{this.productInfo.priceRiseWay==1?'亏吨允许比例':'亏吨允许范围'}}
              </el-form-item>
              <!-- 涨吨允许比例 -->
        ...
        <div class="projectBox">
          <ul class="flex">
            <li>
              <el-form-item label>
                <el-input type="textarea" v-model="mobiles" placeholder="输入承运人手机号 英文状态“,”隔开可多输入多条，例：188xxxx5523,139xxxx6386"></el-input>
              </el-form-item>
            </li>
          </ul>
        </div>
