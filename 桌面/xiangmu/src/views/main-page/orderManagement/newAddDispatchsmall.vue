  ...
  <div class="audit">
    <div class="table_main top20">
      <div class="head_title">
        <h3 class="newAddTitle">{{title}}预派单(非大宗)</h3>
    ...
    chooseItemBtn3(index) {
      ...
      if (this.classIndex >= 0) {
          this.productInfo.orderGoodsList[
              ...
              ].goodsId = this.currentItem.goodsId;
        this.productInfo.orderGoodsList[
          this.goodsItemsIndex
        ...
        .then(res => {
          ...
          if (res.data.code > 0) {
            this.dataList = res.data.data.list.filter(item => {
              return item.projectSettlementClass == 1
            });
          }
        })
        .catch(err => {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          let newProductInfo = {
            ...
            // 物料信息
            truckingGoodsList: this.productInfo.orderGoodsList,
            //
            /**
             * 单价信息 字段
             * 大宗合同
