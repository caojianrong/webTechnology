      ...
      <el-form :model="productInfo" :rules="rules" ref="productInfo" class="demo-dynamic">
          ...
          <ul class="flex">
            ...
            <li>
              <el-form-item prop="projectName">
                <!--
                <el-input disabled class="nobor" placeholder="请选择项目" v-model="productInfo.projectName" clearable></el-input>
                -->
            ...
            <li>
              <el-form-item>
               ...
               <el-select v-model="productInfo.projectBusinessType" disabled placeholder="请选择项目">
                 <el-option v-for="item in getYeWuList" key="item.key" :label="item.value" :value="item.key"></el-option>
               </el-select>
                -->
            ...
            <li>
              <el-form-item>
                <!--
                <el-select disabled v-model="productInfo.projectSettlementWay" placeholder="请选择项目" @change="isJieModel">
                  <el-option
            ...
            <li>
              <el-form-item>
                <!--
                <el-input disabled class="nobor" placeholder="请选择项目" v-model="productInfo.projectSettlementClass" clearable></el-input>
                -->
            ...
            <li>
              <el-form-item>
                <!--
                <el-select disabled v-model="productInfo.projectCalculateWay" placeholder="请选择项目" @change="showOrderCalWay">
                  <el-option
          ...
          <ul class="flex" v-for="(item,index) in productInfo.orderGoodsList" :key="index">
            ...
            <li class="noborder">
              <el-form-item>
                ...
                <el-select class="width80" v-model="item.goodsSettlementUnit" placeholder="单位"  style="position: absolute;right: 0;width:60px;">
                  <el-option
        ...
        <div v-if="isBigZong" class="projectBox">
          ...
          <ul class="flex">
            ...
            <li>
              <!-- 涨吨允许比例 -->
              <el-select v-model="productInfo.priceRiseWay" class="nobor" placeholder="请选择">
                <el-option
...
export default {
  ...
  computed: {
    ...
    isPriceTrue() {
      if (this.productInfo.truckingSettlementWay == 2) {
        return true;
      } else {
        return false;
      }
...
2、无差额需要选择订单计算公式、
    ...
    chooseItemBtn() {
      ...
      if (this.classIndex >= 0) {
        ...
        this.productInfo.projectBusinessTypeName = this.currentItem.projectBusinessTypeName; // 业务类型code
    ...
    newProjectChoose(index) {
      ...
      if (index == 1) {
        ...
        url = this.$api.Basics.getOwnerGroupProjectList;
      ...
      if (index == 2) {
        ...
        url =
          ...
          "?page=1&rows=20" +
          "&addressType=1&project.projectName=" +
            this.productInfo.projectName;
      ...
      if (index == 3) {
        ...
        url =
          this.$api.Basics.line +
          "?page=1&rows=20" +
          "&addressType=2&project.projectName=" +
            this.productInfo.projectName;
      ...
      if (index == 5) {
        ...
        url =
          ...
          "?page=1&rows=20" +
          "&priceType=1&project.projectName=" +
          this.productInfo.projectName;
      }
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          let newProductInfo = {
            ...
            orderProject: {
              orderProjectId: this.productInfo.orderProjectId,
          ...
          if (this.$route.query.orderId) {
            ...
            // console.log(JSON.stringify(newProductInfo), 'newAddOrder')
      ...
      this.$http
        ...
        .then(res => {
          ...
          if (res.data.code > 0) {
            ...
            // console.log(this.dataList,777888)
          }
        })
        .catch(err => {
          this.$message({
  ...
  created() {
    ...
    // console.log(this.productInfo.orderGoodsList,777)
  ...
  mounted() {
    if (this.$route.query.orderId) {
      ...
      this.$http
        ...
        .then(res => {
          if (res.data.code == 1) {
            // console.log(res.data.data, '请求订单信息详情')
            ...
            this.productInfo.projectBusinessTypeName =
              orderDetail.orderProject.projectBusinessTypeName; //业务类型
