...
export default {
  ...
  data() {
    ...
    return {
      ...
      // 表头数据
      auditedName: [
          {tabTh: "提现单号", tabItem: "withdrawCode", isShow: true},
          {tabTh: "提现操作时间", tabItem: "createTime", isShow: true},
          {tabTh: "提现类型", tabItem: "withdrawTypeName", isShow: true},
          {tabTh: "提现账号", tabItem: "withdrawVirtualNo", isShow: true},
          {tabTh: "提现银行账户", tabItem: "withdrawBankRealname", isShow: true},
          {tabTh: "提现银行卡号", tabItem: "withdrawBankAccount", isShow: true},
          {tabTh: "提现金额", tabItem: "withdrawAmount", isShow: true},
          {tabTh: "操作人", tabItem: "createUserName", isShow: true},
          {tabTh: "流水单号", tabItem: "withdrawSwiftNo", isShow: true},
          {tabTh: "提现到账时间", tabItem: "updateTime", isShow: true},
          {tabTh: "提现状态", tabItem: "withdrawStatusName", isShow: true}
      ]
    };
  },
  //监听属性 类似于data概念
  ...
  methods: {
      ...
      getList() {
          ...
          this.$http
              .post(
                  this.$api.Pay.getWithdrawList,param,true
              )
              .then(res => {
                  if(res.data.code == 1) {
                      //表格数据
